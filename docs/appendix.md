...
| 자료 | 설명 |
|------|------|
| [Claude Code for Everyone](https://ccforeveryone.com) | 클로드 코드 기초부터 에이전트까지 실습 |
...
| [KAI 실시간 레포트 (rexa-reports)](https://celine96.github.io/rexa-reports/latest/rexa.html) | 오늘 본 KAI 레포트의 최신 버전 (매주 자동 갱신) |
...
3. 파이프라인 확장하기 — KPI 대시보드 → 자동 알림 → 위클리 메일까지 연결
4. 다른 업무에도 적용해보기 — 반복 업무가 있다면 에이전트로 자동화

---

> 수고하셨어요, 태이님!
> 오늘 배운 것: 클로드 코드 소개 → 설치 → 명령어 → KAI의 KPI 대시보드 체험 → 에이전트 개념 → PRD → 하네스 설계 → 나만의 에이전트 구축
